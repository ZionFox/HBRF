<?php
    ...
    */
    ...
    //Summary Links
    $featuredLink = "https://www.feedthebadger.com/product/subscribe-monthly/"; //This is overridden by a featured fundrasier if there is one
    $subsLink = "https://www.feedthebadger.com/product/subscribe-monthly/"; //For monthly subscriptions
        ...
        if($mysqli->connect_errno) {
            ...
            if(isset($postData)) {
                for($i = 0; $i < count($postData); ++$i) {
                    ...
                    $query = "SELECT post_name FROM wp_rrtxxk_posts WHERE id = " . $postData[$i][1] . " AND post_status = 'publish'";
    ...
    foreach($projectData as $post) {
        ...
        //  client request: The featured fundrasier is overridden by the last most featured fundrasier
        if(in_array("featured", $post["post_categories"])) {
            $featuredImg = $uploadDir['baseurl'] . '/' . $post["_thumbnail_file"];
        ...
        $cards .= 
            '<div class="card">' .
                '<a href="' . $post["ign_project_url"] . '" target="_blank">' . 
                    '<div style="background-image: url(\'' . $uploadDir['baseurl'] . '/' . $post["_thumbnail_file"] . '\');" class="header_image"></div>' .
                '</a>' .
    ...
    while($cardCount < 3) {
        $cards .= '<div class="card"><img src="' . get_template_directory_uri() . '/images/placeholder.gif" alt="Coming Soon" /></div>';
        $cardCount++;
    }
?>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/small.css" type="text/css" media="screen and (max-width: 1270px)" />
    ...
    <body>
        ...
        <header>
            ...
            <div class="media_tiles">
                <img class="follow" src="<?php echo get_template_directory_uri(); ?>/images/follow.svg" alt="Follow Us!" />
                <a target="_blank" href="<?php echo $youtubeLink; ?>" title="Visit our YouTube channel!"><img src="<?php echo get_template_directory_uri(); ?>/images/youtube.png" alt="YouTube" /></a>
                <a target="_blank" href="<?php echo $twitterLink; ?>" title="Visit our Twitter!"><img src="<?php echo get_template_directory_uri(); ?>/images/twitter.png" alt="Twitter" /></a>
                <a target="_blank" href="<?php echo $libsynLink; ?>" title="Visit our Libsyn!"><img src="<?php echo get_template_directory_uri(); ?>/images/libsyn.png" alt="Libsyn" /></a>
                <a target="_blank" href="<?php echo $facebookLink; ?>" title="Visit our Facebook Page!"><img src="<?php echo get_template_directory_uri(); ?>/images/facebook.png" alt="Facebook" /></a>
                <a target="_blank" href="<?php echo $mindsLink; ?>" title="Visit our Minds page!"><img src="<?php echo get_template_directory_uri(); ?>/images/minds.png" alt="Minds" /></a>
                <div style="display: inline-block; cursor: pointer;" onclick="toggleMailList();" title="Sign up to our Mailing List!"><img style="box-shadow: 0px 0px 0px rgba(0, 0, 0, 0);" src="<?php echo get_template_directory_uri(); ?>/images/maillist.png" alt="Mailing List" /></div>
        ...
        <main>
            <article>
                ...
                <div id="group">
                    ...
                    <a class="once button" target="_blank" href="<?php echo $featuredLink; ?>" title="Featured Fundraiser.">I WANNA FEED THE BADGER!<img src="<?php echo get_template_directory_uri(); ?>/images/feed.svg" alt="" /></a>
                    <a class="month button" target="_blank" href="<?php echo $subsLink; ?>" title="Monthly subscription."><span>I WANNA FEED THE BADGER</span><span>MONTHLY!</span><img src="<?php echo get_template_directory_uri(); ?>/images/monthly.svg" alt="" /></a>
                </div>
            </article>
            ...
            <article id="slider">
                ...
                <form id="pp" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
                    ...
                    <button type="submit" name="submit" title="PayPal - The safer, easier way to pay online!"><img src="<?php echo get_template_directory_uri(); ?>/images/paypal.svg" alt="PayPal" />PAL CHIPS!</button>
                </form>
            </article>

            <article id="donate">
                <h2 class="tagline">Other ways to help:</h2>
                <a class="bitcoin button" href="<?php echo $bitcoinLink; ?>" target="_blank" title="Support us using Bitcoin!"><img src="<?php echo get_template_directory_uri(); ?>/images/bitcoin.svg" alt="Bitcoin" />GIVE US BITCOIN!</a>
                <a class="volunteer button" href="<?php echo $lootLink; ?>" target="_blank" title="Buy some Badger Merch!"><img src="<?php echo get_template_directory_uri(); ?>/images/loot.svg" alt="" />GET SOME AWZM LOOT!</a>
                <a class="patron button" target="_blank" href="<?php echo $patronLink; ?>" title="Monthly Subscription through Patreon."><img src="<?php echo get_template_directory_uri(); ?>/images/patreon.svg" alt="Patreon" />PATRONIZE US!</a><!-- Should be "Patronise"!!! -->
            </article>
        ...
        <footer>
            ...
            <div id="copyright">Designed by <img src="<?php echo get_template_directory_uri(); ?>/images/badgerlabs.png" alt="BadgerLabs" />&copy; <?php echo date('Y'); ?> - Honey Badger Radio Ltd.</div>
